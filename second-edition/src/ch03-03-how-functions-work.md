...
Функция - это ключевая часть Rust кода. Вы, конечно, знакомы с самой важной функцией.
...
Важной особенностью Rust является тот факт, что язык разделяет понятия операторы
...
значение. Вызов функции или макроса, блок кода - это всё выражения.
...
Будуте ошибка при компиляции с весьма доходчивым описанием как эту ошибку можно
исправить:
