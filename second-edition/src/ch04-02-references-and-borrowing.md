...
1. В одной области видимости единовременно может существовать только один тип ссылочных переменных на одни данные, но не два:
  - одна изменяемая ссылка на данные без неизменяемых,
