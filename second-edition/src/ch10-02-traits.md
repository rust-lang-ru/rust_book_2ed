...
трудозатраты программистаx, если это поведения ему подходит в его структурах.
...
добавить в них элементы обобщенного программирования. Мы можеv сократить количество
