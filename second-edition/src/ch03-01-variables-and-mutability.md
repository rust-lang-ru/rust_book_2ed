...
добавить ключевое слово `mut` при декларировании переменной. Также 
явное указание этой особенности переменной повышает читаемость исходного кода.
...
Вы, скорее всего, обратили внимание, что поведение "неизменяемых переменных" весьма
