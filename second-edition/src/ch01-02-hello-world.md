...
Есть определённые стилистические уточнения. Во-первых, для написания кода
...
Далее, в круглых скобках находится *строка* `"Привет, мир!"`.
...
окончено и можно напечатать другое. Большинство строк кода Rust заканчивается на `;`.
