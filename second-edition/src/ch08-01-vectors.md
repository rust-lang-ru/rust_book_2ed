...
При работе памяти с объектами, вектор ведёт себя также как и структура. Память, занимаемая
...
программа аварийно прекращает работу, а во втором случае, просто возвращает `None`).
...
Бывают ситуации, когда нужно хранить разные типы данных. В этом им помогут перечисления.
