...
По умолчанию Cargo создаёт консольный проект. Если при создании нового проекта мы установим флаг `--lib`, то будет создана библиотека:
...
вы и здесь напишите декларацию модуля `mod client`, то это будет значить, что внутри модуля
...
<span class="filename">Имя файла: src/network.rs</span>
...
<span class="filename">Имя файла: src/server.rs</span>
