...
В этом случае, когда мы создаём библиотеку, файл *src/lib.rs* хранит точку доступа к
...
его в файле *src/lib.rs*. Файл же *src/client.rs* содержит компоненты модуля `client`. Если же
