...
> когда функция прекращает работу все переменные функции удаляются из стека.
>
...
Для упрощения работы при передаче данных в функцию и из функции удобно использовать
кортежи:
